 ...
 * @param dbService - Instância do serviço de backend
 */
export type TransformGetFn = (item: unknown, dbService: IBackendService) => unknown | Promise<unknown>;
 ...
 * @param dbService - Instância do serviço de backend
 */
export type TransformPostFn = (body: unknown, dbService: IBackendService) => unknown | Promise<unknown>;
 ...
 * @param dbService - Instância do serviço de backend
 */
export type TransformPutFn = (item: unknown, body: unknown, dbService: IBackendService) => unknown | Promise<unknown>;
...
export interface IBackendService {
   ...
   * @returns Uma Promise que retorna a listagem dos itens quando completo.
   */
   ...
   * @returns Uma Promise que retorna uma resposta HTTP contendo o item ou os itens no corpo da mesma
   */
  get$<T = unknown>(
   ...
   * @param url URl a ser utilizada na resposta
   * @returns Uma Promise que retorna uma resposta HTTP indicando sucesso ou erro na operação
   * @alias BackendConfigArgs
   */
  post$(collectionName: string, id: string, item: unknown, url: string): Promise<IHttpResponse<unknown>>;
   ...
   * @alias BackendConfigArgs
   */
  put$(collectionName: string, id: string, item: unknown, url: string): Promise<IHttpResponse<unknown>>;
...
export interface IBackendUtils {
  ...
  createResponseOptions<T = unknown>(url: string, status: number, body?: T): IHttpResponse<T>;
