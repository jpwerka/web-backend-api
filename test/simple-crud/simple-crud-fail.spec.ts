...
describe('Testes de falha de uma aplicação CRUD simples', () => {
  ...
  [{ dbtype: 'memory' }, { dbtype: 'indexdb' }].forEach((dbType) => {
    ...
    it(`Deve retornar NOT_FOUND ao fazer a busca por um id inexistente. DbType: ${dbType.dbtype}`, (done) => {
      // given
    ...
    it(`Deve retornar BAD_REQUEST ao tentar fazer POST com ID diferente do body. DbType: ${dbType.dbtype}`, (done) => {
      // given
    ...
    it(`Deve retornar CONFLICT ao tentar fazer POST para atualizar item existente. DbType: ${dbType.dbtype}`, (done) => {
      // given
      const req: IRequestCore<Partial<ICustomer>> = {
        method: 'POST',
    ...
    it(`Deve retornar BAD_REQUEST ao tentar fazer PUT sem informar o ID. DbType: ${dbType.dbtype}`, (done) => {
      // given
      const req: IRequestCore<Partial<ICustomer>> = {
        method: 'PUT',
    ...
    it(`Deve retornar BAD_REQUEST ao tentar fazer PUT com ID diferente do body. DbType: ${dbType.dbtype}`, (done) => {
      // given
      const req: IRequestCore<Partial<ICustomer>> = {
        method: 'PUT',
        url: `http://localhost/${collectionCustomers}/99`,
    ...
    it(`Deve retornar NOT_FOUND ao tentar fazer PUT para ID inexistente. DbType: ${dbType.dbtype}`, (done) => {
      // given
      const req: IRequestCore<Partial<ICustomer>> = {
        method: 'PUT',
    ...
    it(`Deve retornar BAD_REQUEST ao tentar fazer DELETE sem informar o ID. DbType: ${dbType.dbtype}`, (done) => {
      // given
      const req: IRequestCore<null> = {
        method: 'DELETE',
        url: `http://localhost/${collectionCustomers}`,
    ...
    it(`Deve retornar NOT_FOUND ao tentar fazer DELETE para ID inexistente. DbType: ${dbType.dbtype}`, (done) => {
      // given
      const req: IRequestCore<null> = {
        method: 'DELETE',
        url: `http://localhost/${collectionCustomers}/90`,
